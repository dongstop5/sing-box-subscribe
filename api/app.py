...
def config(url):
    ...
    temp_json_data = json.loads('{"subscribes":[{"url":"删掉此处中文后填入你的订阅链接然后点击保存","tag":"tag_1","enabled":true,"emoji":0,"subgroup":"","prefix":"","ex-node-name": "","User-Agent":"v2rayng"},{"url":"删掉此处中文后填入你的订阅链接然后点击保存","tag":"tag_2","enabled":false,"emoji":0,"subgroup":"","prefix":"","ex-node-name": "","User-Agent":"v2rayng"},{"url":"删掉此处中文后填入你的订阅链接然后点击保存","tag":"tag_3","enabled":false,"emoji":0,"subgroup":"","prefix":"","ex-node-name": "","User-Agent":"v2rayng"}],"auto_set_outbounds_dns":{"proxy":"","direct":""},"save_config_path":"./config.json","auto_backup":false,"exclude_protocol":"ssr","config_template":"","Only-nodes":false}')
